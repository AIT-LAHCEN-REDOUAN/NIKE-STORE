...
const client = "1075028744419-as17k0pbj1pk9tc2eu56fnc7qs1tvcrs.apps.googleusercontent.com"
        ...
        <nav className='flex items-center justify-between nike-container'>
            ...
            <ul className='flex items-center justify-center gap-2'>
                ...
                <button  type='button' className='border-none outline-none active:scale-110 transition-all duration-300 relative'>
                        <GoogleLogin className={`icon-style ${navState && "text-slate-900 transition-all duration-300"}`} clientId={client}  buttonText ="Login" onSuccess={Success} onError={failure}  />
